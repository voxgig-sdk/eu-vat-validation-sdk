...
const testSeed = `map[string]any{"entity": map[string]any{"validate_format": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "vat": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`

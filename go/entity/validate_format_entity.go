...
type ValidateFormatEntity struct {
	name    string
	client  *core.EuVatValidationSDK
...
func NewValidateFormatEntity(client *core.EuVatValidationSDK, entopts map[string]any) *ValidateFormatEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ValidateFormatEntity) GetName() string { return e.name }
...
func (e *ValidateFormatEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ValidateFormatEntity) Deleted() bool {
	return e.deleted
}


func (e *ValidateFormatEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewValidateFormatEntity(e.client, opts)
}

func (e *ValidateFormatEntity) Data(args ...any) any {
...
func (e *ValidateFormatEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ValidateFormat; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ValidateFormatEntity) DataTyped(data ...ValidateFormat) ValidateFormat {
	if len(data) > 0 {
		return typedFrom[ValidateFormat](e.Data(asMap(data[0])))
	}
	return typedFrom[ValidateFormat](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ValidateFormat (all fields
// optional at the wire level).
func (e *ValidateFormatEntity) MatchTyped(match ...ValidateFormat) ValidateFormat {
	if len(match) > 0 {
		return typedFrom[ValidateFormat](e.Match(asMap(match[0])))
	}
	return typedFrom[ValidateFormat](e.Match())
}
...
func (e *ValidateFormatEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ValidateFormatEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ValidateFormatLoadMatch and returns an ValidateFormat. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ValidateFormatEntity) LoadTyped(reqmatch ValidateFormatLoadMatch, ctrl map[string]any) (ValidateFormat, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ValidateFormat{}, err
	}
	return typedFrom[ValidateFormat](res), nil
}



func (e *ValidateFormatEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ValidateFormatEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ValidateFormatEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ValidateFormatEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ValidateFormatEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

...
func NewVatEntity(client *core.EuVatValidationSDK, entopts map[string]any) *VatEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *VatEntity) GetName() string { return e.name }
...
func (e *VatEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *VatEntity) Deleted() bool {
	return e.deleted
}


func (e *VatEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVatEntity(e.client, opts)
}

func (e *VatEntity) Data(args ...any) any {
...
func (e *VatEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Vat; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *VatEntity) DataTyped(data ...Vat) Vat {
	if len(data) > 0 {
		return typedFrom[Vat](e.Data(asMap(data[0])))
	}
	return typedFrom[Vat](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Vat (all fields
// optional at the wire level).
func (e *VatEntity) MatchTyped(match ...Vat) Vat {
	if len(match) > 0 {
		return typedFrom[Vat](e.Match(asMap(match[0])))
	}
	return typedFrom[Vat](e.Match())
}
...
func (e *VatEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *VatEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// VatLoadMatch and returns an Vat. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *VatEntity) LoadTyped(reqmatch VatLoadMatch, ctrl map[string]any) (Vat, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Vat{}, err
	}
	return typedFrom[Vat](res), nil
}



func (e *VatEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *VatEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *VatEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *VatEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *VatEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

...
|---|---|---|
| `ts/` | @voxgig-sdk/eu-vat-validation-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/eu-vat-validation-sdk \
      --repository voxgig-sdk/eu-vat-validation-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/eu-vat-validation-sdk` shows it, and
`npm trust revoke @voxgig-sdk/eu-vat-validation-sdk --id=<id>` removes it.

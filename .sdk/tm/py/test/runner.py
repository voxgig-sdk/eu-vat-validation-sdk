...
class EuVatValidationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = EuVatValidationTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = EuVatValidationTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = EuVatValidationTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")

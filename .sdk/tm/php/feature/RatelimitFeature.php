...
// EuVatValidation SDK ratelimit feature
...
class EuVatValidationRatelimitFeature extends EuVatValidationBaseFeature
{
    ...
    private function _acquire(EuVatValidationContext $ctx): void
    {
    ...
    private function _track(EuVatValidationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

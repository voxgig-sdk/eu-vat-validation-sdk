...
// EuVatValidation SDK clienttrack feature
...
class EuVatValidationClienttrackFeature extends EuVatValidationBaseFeature
{
    ...
    public function PostConstruct(EuVatValidationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'EuVatValidation-SDK';

...
// EuVatValidation SDK timeout feature
...
class EuVatValidationTimeoutFeature extends EuVatValidationBaseFeature
{
    ...
    private function _with_timeout(EuVatValidationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(EuVatValidationContext $_ctx, float $ms): void
    {
        $client = $this->client;

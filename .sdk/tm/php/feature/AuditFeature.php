...
// EuVatValidation SDK audit feature
...
class EuVatValidationAuditFeature extends EuVatValidationBaseFeature
{
    ...
    private function _emit(EuVatValidationContext $ctx, string $outcome): void
    {

...
// EuVatValidation SDK utility: fetcher

class EuVatValidationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; EuVatValidationSDK/1.0)';
    ...
    public static function call(EuVatValidationContext $ctx, string $fullurl, array $fetchdef): array
    {

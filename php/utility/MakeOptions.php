...
// EuVatValidation SDK utility: make_options

class EuVatValidationMakeOptions
{
    ...
    public static function call(EuVatValidationContext $ctx): array
    {
        ...
        //
        // `EuVatValidationSchema::optspec()` is built from the model:
        ...
        $optspec = EuVatValidationSchema::optspec();

...
// EuVatValidation SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class EuVatValidationTransformResponse
{
    public static function call(EuVatValidationContext $ctx): mixed
    {
        ...
        $transform = EuVatValidationHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }

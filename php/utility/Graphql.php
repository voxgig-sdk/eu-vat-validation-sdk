...
// EuVatValidation SDK utility: graphql
//
...
class EuVatValidationGraphql
{
    ...
    // equivalent.
    public static function body(EuVatValidationContext $ctx): mixed
    {
    ...
    public static function errors(EuVatValidationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

...
// EuVatValidation SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (EuVatValidationSDK::test)
...
{
    private const SDK_CLASS = 'EuVatValidationSDK';
    ...
    private const SDK_BASE = 'euvatvalidation_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../euvatvalidation_sdk.php';
        foreach ($this->phpBlocks() as $blk) {

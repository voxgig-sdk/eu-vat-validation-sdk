...
// EuVatValidation SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = EuVatValidationOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(EuVatValidationOmni::structfix($now, Struct::undef()))
                        !== json_encode(EuVatValidationOmni::structfix($val, Struct::undef()))) {

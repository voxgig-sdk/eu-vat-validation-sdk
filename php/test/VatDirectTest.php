...
class VatDirectTest extends TestCase
{
    public function test_direct_load_vat(): void
    {
        $setup = vat_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-vat", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function vat_direct_setup($mockres)
{

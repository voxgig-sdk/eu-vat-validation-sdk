...
class ValidateFormatEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set EUVATVALIDATION_TEST_VALIDATE_FORMAT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function validate_format_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("EUVATVALIDATION_TEST_VALIDATE_FORMAT_ENTID");

...
// EuVatValidation SDK utility type

class EuVatValidationUtility
{
    ...
    public static function copy(EuVatValidationUtility $src): EuVatValidationUtility
    {
        $u = new EuVatValidationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;

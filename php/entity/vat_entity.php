...
// EuVatValidation SDK Vat entity
...
class VatEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new VatEntity($this->_client, $opts);
    }

    /**
     * @param Vat|array $args Vat data (assoc-array) to store.
     */
    ...
    /**
     * @return Vat|array The current Vat data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Vat fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Vat fields).
     */
     ...
     * Load a single Vat.
     *
     * @param VatLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed VatLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Vat|array The loaded Vat as an assoc-array at the

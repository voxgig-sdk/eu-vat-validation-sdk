...
// EuVatValidation SDK cache feature
...
class EuVatValidationCacheFeature extends EuVatValidationBaseFeature
{
    ...
    private function _through(EuVatValidationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

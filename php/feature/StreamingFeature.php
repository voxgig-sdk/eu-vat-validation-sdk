...
// EuVatValidation SDK streaming feature
...
class EuVatValidationStreamingFeature extends EuVatValidationBaseFeature
{
    ...
    private function _iterate(EuVatValidationResult $result): \Generator
    {
    ...
    private function _streamable(EuVatValidationContext $ctx): bool
    {

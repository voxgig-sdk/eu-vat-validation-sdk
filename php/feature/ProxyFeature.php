...
// EuVatValidation SDK proxy feature
...
class EuVatValidationProxyFeature extends EuVatValidationBaseFeature
{
    ...
    public function init(EuVatValidationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (EuVatValidationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

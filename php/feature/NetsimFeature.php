...
// EuVatValidation SDK netsim feature
...
class EuVatValidationNetsimFeature extends EuVatValidationBaseFeature
{
    ...
    private function _simulate(EuVatValidationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(EuVatValidationContext $ctx, array $applied): void
    {
        $client = $this->client;

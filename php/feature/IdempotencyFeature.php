...
// EuVatValidation SDK idempotency feature
...
class EuVatValidationIdempotencyFeature extends EuVatValidationBaseFeature
{
    ...
    private function _mutating(EuVatValidationContext $ctx): bool
    {

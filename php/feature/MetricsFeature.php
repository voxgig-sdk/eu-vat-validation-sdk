...
// EuVatValidation SDK metrics feature
...
class EuVatValidationMetricsFeature extends EuVatValidationBaseFeature
{
    ...
    private function _record(EuVatValidationContext $ctx, bool $ok): void
    {

...
// EuVatValidation SDK rbac feature
...
class EuVatValidationRbacFeature extends EuVatValidationBaseFeature
{
    ...
    private function _required(EuVatValidationContext $ctx): ?string
    {
    ...
    private function _reject(EuVatValidationContext $ctx, string $required): void
    {
    ...
    private function _track(EuVatValidationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

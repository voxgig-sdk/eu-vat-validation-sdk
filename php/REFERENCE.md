# EuVatValidation PHP SDK Reference

Complete API reference for the EuVatValidation PHP SDK.
...
#### `EuVatValidationSDK::test($testopts = null, $sdkopts = null)`
...
#### `ValidateFormat($data = null)`

Create a new `ValidateFormatEntity` instance. Pass `null` for no initial data.

#### `Vat($data = null)`

Create a new `VatEntity` instance. Pass `null` for no initial data.

#### `options_map(): array`

Return a deep copy of the current SDK options.

#### `get_utility(): EuVatValidationUtility`

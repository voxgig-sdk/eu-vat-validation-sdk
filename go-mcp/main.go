// Command EuVatValidation-mcp is an MCP server exposing the EuVatValidation
// SDK as MCP tools.
//
// Two tools are registered:
//
//	EuVatValidation_list  — list records of an entity
//	EuVatValidation_load  — load a single record of an entity
//

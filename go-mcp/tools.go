...
type Args struct {
	Entity string         `json:"entity" jsonschema:"validate_format | vat"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.EuVatValidationSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "eu-vat-validation_list",
		Description: "List records from EuVatValidation. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "eu-vat-validation_load",
		Description: "Load a single record from EuVatValidation. " +
...
func runOp(client *sdk.EuVatValidationSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.EuVatValidationSDK, name string) (sdk.EuVatValidationEntity, error) {
	switch strings.ToLower(name) {
	case "validate_format":
		return client.ValidateFormat(nil), nil
	case "vat":
		return client.Vat(nil), nil

...
func registerSDKWords(r *eng.Registry, client *sdk.EuVatValidationSDK) {
...
func runOp(client *sdk.EuVatValidationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

...
local ValidateFormatEntity = {}
ValidateFormatEntity.__index = ValidateFormatEntity


function ValidateFormatEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ValidateFormatEntity)
...
function ValidateFormatEntity:get_name()
  return self._name
end


function ValidateFormatEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ValidateFormatEntity.new(self._client, opts)
end
...
function ValidateFormatEntity:mark_deleted()
  self._deleted = true
end


function ValidateFormatEntity:deleted()
  return true == self._deleted
end


function ValidateFormatEntity:data_set(args)
  if args ~= nil then
...
function ValidateFormatEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ValidateFormatEntity:match_set(args)
  if args ~= nil then
...
function ValidateFormatEntity:match_get()
...
function ValidateFormatEntity:stream(action, args, callopts)
...
---@param reqmatch ValidateFormatLoadMatch
---@param ctrl? table
---@return ValidateFormat
---@return string? err
function ValidateFormatEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ValidateFormatEntity:_run_op(ctx, post_done)
  local utility = self._utility

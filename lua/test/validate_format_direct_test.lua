...
describe("ValidateFormatDirect", function()
  it("should direct-load-validate_format", function()
    local setup = validate_format_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-validate_format", setup.live and "live" or "unit")

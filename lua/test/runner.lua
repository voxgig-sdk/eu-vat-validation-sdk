...
function runner.env_override(m)
  local live = runner.getenv("EUVATVALIDATION_TEST_LIVE")
  local override = runner.getenv("EUVATVALIDATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("EUVATVALIDATION_TEST_EXPLAIN")

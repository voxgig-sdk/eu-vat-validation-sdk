...
describe("VatDirect", function()
  it("should direct-load-vat", function()
    local setup = vat_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-vat", setup.live and "live" or "unit")

...
class ValidateFormatEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set EUVATVALIDATION_TEST_VALIDATE_FORMAT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def validate_format_basic_setup(extra)
  ...
  entid_env_raw = ENV["EUVATVALIDATION_TEST_VALIDATE_FORMAT_ENTID"]

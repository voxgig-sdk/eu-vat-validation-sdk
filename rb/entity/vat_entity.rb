...
class VatEntity
  ...
  # @return [Vat, Hash] the current Vat data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Vat fields)
  def match_get
  ...
  # Load a single Vat.
  #
  # @param reqmatch [VatLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Vat.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Vat, Hash] the loaded Vat; raises EuVatValidationError on failure

...
(0, node_test_1.describe)('ValidateFormatDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.EuVatValidationSDK({
    ...
    (0, node_test_1.test)('direct-load-validate_format', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-validate_format', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.EU_VAT_VALIDATION_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.EuVatValidationSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.EU_VAT_VALIDATION_APIKEY,
        }));
        let idmap = env['EU_VAT_VALIDATION_TEST_VALIDATE_FORMAT_ENTID'];
    ...
    const client = new __1.EuVatValidationSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ValidateFormatDirect.test.js.map
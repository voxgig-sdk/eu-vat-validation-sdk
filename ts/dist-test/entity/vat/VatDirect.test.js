...
(0, node_test_1.describe)('VatDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-vat', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-vat', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['EU_VAT_VALIDATION_TEST_VAT_ENTID'];
...
//# sourceMappingURL=VatDirect.test.js.map
# EuVatValidation SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions EuVatValidationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both EuVatValidationSDK(...) and EuVatValidationSDK.test(...) become
#      EuVatValidationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "euvatvalidation_sdk"
_SDK_CLASS = "EuVatValidationSDK"
...
_ENTITIES = {
    "ValidateFormat": "validate_format",
    "Vat": "vat",
}

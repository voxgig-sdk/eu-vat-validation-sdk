...
def make_error_util(ctx, err):
    if ctx is None:
        from euvatvalidation_sdk.core.context import EuVatValidationContext
        ctx = EuVatValidationContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, EuVatValidationError):
        errmsg = err.msg
    ...
    sdk_err = EuVatValidationError("", msg, ctx)

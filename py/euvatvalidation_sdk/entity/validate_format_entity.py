...
from euvatvalidation_sdk.euvatvalidation_types import (
    ValidateFormat,
...
class ValidateFormatEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ValidateFormatEntity(self._client, opts)
    ...
    def data_get(self) -> ValidateFormat:
    ...
    def match_get(self) -> ValidateFormat:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ValidateFormat:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ValidateFormat().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
